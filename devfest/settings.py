...
SECRET_KEY = 'g25moudlj&%)zm2rc%=i+eo2*ia5__lc^)ekw-xny7p(##oi&='
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    'devfest.context_processors.authentication_info' 
)
...
# Automatically creates 'devfest' admin account upon start of the application.
